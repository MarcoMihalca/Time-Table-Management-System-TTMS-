...
def calculeaza_fitness(orar):
    ...
    # Normalize fitness to range [0, 100]
    # Use higher denominator to account for possible bonus accumulation
    # Theoretical max: 2000 (no penalty) + ~1200 (global day bonus) + ~600 (tasks) + other bonuses = ~4500+
